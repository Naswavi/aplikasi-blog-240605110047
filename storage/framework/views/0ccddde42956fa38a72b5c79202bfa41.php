...
<head>
    ...
    <title><?php echo e($article->judul); ?> - Blog Kami</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto align-items-center">
                    <a class="nav-link-custom" href="<?php echo e(route('home')); ?>">Beranda</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 border-right-custom mb-5">
                <div class="card-detail-wrapper">
                    <span class="badge mb-2" style="background-color:#4CAF50;" style="font-size: 0.8rem; padding: 6px 12px; border-radius: 4px;"><?php echo e($article->kategori->nama_kategori ?? 'Umum'); ?></span>
                    <h1 class="article-title-large mb-3"><?php echo e($article->judul); ?></h1>
                    
                    <div class="meta-text">
                        Oleh: <strong><?php echo e($article->penulis->nama ?? 'Anonim'); ?></strong> <span class="mx-1">|</span> Diterbitkan pada: <?php echo e($article->hari_tanggal); ?>

                    </div>

                    <?php if($article->gambar): ?>
<div class="mb-4">
    <img src="<?php echo e(asset('storage/gambar/' . $article->gambar)); ?>"
...
<?php endif; ?>  
                    ...
                    <div class="mt-5 pt-4 border-top">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-sm" style="border:1px solid #4CAF50; color:#4CAF50;">← Kembali ke Beranda</a>
                    </div>
                </div>
            </div>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $relatedArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mb-3 pb-3 border-bottom border-light">
                                <a href="<?php echo e(route('artikel.detail', $rel->id)); ?>" class="related-link"><?php echo e($rel->judul); ?></a>
                                <small class="text-muted" style="font-size: 0.8rem;">🕒 <?php echo e($rel->hari_tanggal); ?></small>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\aplikasi-blog\resources\views/home/show.blade.php ENDPATH**/ ?>